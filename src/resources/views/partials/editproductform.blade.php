    ...
    <div class="col-sm-5">
        <div class="product-name">
            ...
            <div class="Bigdescription">
              ...
              <textarea rows="7" cols="70" class="form-control" name="bigdescription" id="bigdescription" autofocus>{{$product->bigdescription}}
              </textarea>
            ...
            <div class="Shortdescription">
              ...
              <textarea rows="3" cols="70" class="form-control" name="shortdescription" id="shortdescription"  autofocus>{{$product->shortdescription}}
              </textarea>
