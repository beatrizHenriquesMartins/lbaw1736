    ...
    <div class="col-sm-5">
        <div class="product-name">
            ...
            <div class="Bigdescription">
              ...
              <textarea rows="7" cols="70" class="form-control" name="bigdescription" id="bigdescription" autofocus>@if(old('bigdescription')){{old('bigdescription')}}@endif
              </textarea>
            ...
            <div class="Shortdescription">
              ...
              <textarea rows="3" cols="70" class="form-control" name="shortdescription" id="shortdescription"  autofocus>@if(old('shortdescription')){{old('shortdescription')}}@endif
              </textarea>
