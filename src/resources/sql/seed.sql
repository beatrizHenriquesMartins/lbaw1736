...
INSERT INTO brands VALUES (DEFAULT, 'Bertrand', 223143243, '/images/brands/bateye/bateye.png');
...
INSERT INTO brands VALUES (DEFAULT, 'Porto Editora', 223143243, '/images/brands/porto_editora/porto_editora.png');
...
INSERT INTO brands VALUES (DEFAULT, 'Sport Zone', 223143243, '/images/brands/sport_zone/sport_zone.png');
...
Uso Diário.', 'Combinando as fragrâncias mais requintadas com os melhores óleos e manteigas vegetais, o sabonete “Frangipani” oferece uma limpeza profunda, deixando a pele preparada para receber os benefícios de beleza diários.', 25, 2, 1, 0);
...
Uso Diário.', 'Combinando as fragrâncias mais requintadas com os melhores óleos e manteigas vegetais, o sabonete “Violeta” oferece uma limpeza profunda, deixando a pele preparada para receber os benefícios de beleza diários.', 25, 2, 1, 0);
...
Uso Diário.', 'Combinando as fragrâncias mais requintadas com os melhores óleos e manteigas vegetais, o sabonete “Gardénia” oferece uma limpeza profunda, deixando a pele preparada para receber os benefícios de beleza diários.', 25, 2, 1, 0);
...
INSERT INTO products VALUES (DEFAULT, 'Drone II', 10, now(), 99.99, '/images/brands/science4you/drone2.png', 'Os drones parecem ter surgido de um dia para o outro nas nossas vidas mas a verdade é que estes pequenos “aviões”, controlados à distância, surgiram pela primeira vez para fins militares. Estes pequenos veículos aéreos não tripulados são controlados por meios eletrónicos e computacionais e foram pensados e construídos para serem usados em missões normalmente de alto risco para humanos. Hoje em dia os drones são usados para fins lúdicos e além das corridas que se podem fazer com eles, os drones com câmaras permitem também tirar fotografias e fazer vídeos incríveis. Nas lojas Science4you pode encontrar os melhores drones para quem procura diversão. O Drone4you, o drone da Science4you, é um brinquedo educativo que ajuda a desenvolver a concentração, o raciocínio e a interação social. E como os nossos drones são os melhores, não poderiamos deixar de incluir em cada aparelho um livro educativo com curiosidades sobre este brinquedo e as funcionalidades deste avião aéreo.', 'Com as luzes LED coloridas, diverte-te a telecomandar o teu drone tanto de dia, como de noite! Com cartão de memória de 4G, este modelo é ideal para iniciantes, sejam crianças ou adultos.', 36, 3, 1, 0);

INSERT INTO products VALUES (DEFAULT, 'Summo Pêssego', 50, now(), 1.99, '/images/brands/compal/summo_pessego.png', 'Somos especialistas a trabalhar fruta, somos Frutologia: arte, ciência e ideologia. Somos fruta selecionada. Somos fruta de qualidade superior, de variedade e origem determinada e apenas utilizamos ingredientes naturais. Preservamos o melhor que a natureza nos oferece e com isso obtemos o sabor único e inigualável que carateriza a autenticidade de Compal. Neste produto, Combinamos diferentes variedades de pêssego e outras frutas com muita paixão e cochecimento para obtermos as receitas mais saborosas.', 'Combinamos diferentes variedades de pêssego e outras frutas com muita paixão e cochecimento para obtermos as receitas mais saborosas.', 24, 4, 1, 0);

INSERT INTO products VALUES (DEFAULT, 'Summo Pêra', 50, now(), 1.99, '/images/brands/compal/summo_pera.png', 'Somos especialistas a trabalhar fruta, somos Frutologia: arte, ciência e ideologia. Somos fruta selecionada. Somos fruta de qualidade superior, de variedade e origem determinada e apenas utilizamos ingredientes naturais. Preservamos o melhor que a natureza nos oferece e com isso obtemos o sabor único e inigualável que carateriza a autenticidade de Compal. Neste produto, Combinamos diferentes variedades de pêra e outras frutas com muita paixão e cochecimento para obtermos as receitas mais saborosas.', 'Combinamos diferentes variedades de pêra e outras frutas com muita paixão e cochecimento para obtermos as receitas mais saborosas.', 24, 4, 1, 0);

INSERT INTO products VALUES (DEFAULT, 'Summo Frutos Vermelhos', 50, now(), 1.99, '/images/brands/compal/summo_frutos_vermelhos.png', 'Somos especialistas a trabalhar fruta, somos Frutologia: arte, ciência e ideologia. Somos fruta selecionada. Somos fruta de qualidade superior, de variedade e origem determinada e apenas utilizamos ingredientes naturais. Preservamos o melhor que a natureza nos oferece e com isso obtemos o sabor único e inigualável que carateriza a autenticidade de Compal. Neste produto, Combinamos diferentes variedades de frutos vermelhos e outras frutas com muita paixão e cochecimento para obtermos as receitas mais saborosas.', 'Combinamos diferentes variedades de frutos vermelhos e outras frutas com muita paixão e cochecimento para obtermos as receitas mais saborosas.', 24, 4, 1, 0);

INSERT INTO products VALUES (DEFAULT, 'Summo Laranja', 50, now(), 1.99, '/images/brands/compal/summo_laranja.png', 'Somos especialistas a trabalhar fruta, somos Frutologia: arte, ciência e ideologia. Somos fruta selecionada. Somos fruta de qualidade superior, de variedade e origem determinada e apenas utilizamos ingredientes naturais. Preservamos o melhor que a natureza nos oferece e com isso obtemos o sabor único e inigualável que carateriza a autenticidade de Compal. Neste produto, Combinamos diferentes variedades de laranja e outras frutas com muita paixão e cochecimento para obtermos as receitas mais saborosas.', 'Combinamos diferentes variedades de laranja e outras frutas com muita paixão e cochecimento para obtermos as receitas mais saborosas.', 24, 4, 1, 0);

INSERT INTO products VALUES (DEFAULT, 'Diz-me Quem Eu Sou', 20, now(), 19.90, '/images/brands/bertrand/diz_me_quem_sou.jpeg', 'Escrito por Ana Navarro, é uma apaixonante aventura protagonizada por personagens inesquecíveis, cujas vidas constroem um magnífico retrato da história do século XX. Desde os anos da Segunda República espanhola até à queda do Muro de Berlim, passando pela Segunda grande Guerra e pela Guerra Fria, o novo romance de Julia Navarro transborda de intriga, política, espionagem, amor e traição.', 'Escrito por Ana Navarro, é uma apaixonante aventura protagonizada por personagens inesquecíveis, cujas vidas constroem um magnífico retrato da história do século XX. ', 11, 5, 1, 0);

INSERT INTO products VALUES (DEFAULT, 'Casa de Espiões', 20, now(), 18.90, '/images/brands/bertrand/casa_de_espioes.jpeg', 'Daniel Silva está de volta com um novo êxito protagonizado por Gabriel Allon, espião lendário, assassino profissional e restaurador de arte.
...
Essa ponta solta levará Gabriel Allon ao sul de França, decidido a apanhar o terrorista mais perigoso do mundo, o escorregadio cérebro do ISIS conhecido como Saladino. ', 'Daniel Silva está de volta com um novo êxito protagonizado por Gabriel Allon, espião lendário, assassino profissional e restaurador de arte. ', 11, 5, 1, 0);

INSERT INTO products VALUES (DEFAULT, 'Duas ou Três Coisas Sobre Mim', 20, now(), 15.50, '/images/brands/bertrand/duas_ou_tres_coisas_sobre_mim.jpeg', 'Esta é uma viagem pelos bastidores de uma profissão que apaixona Judite Sousa há quase quarenta anos.
...
Um livro sobre a vida nos bons e nos maus momentos, nas dúvidas e nas certezas, assinado por uma das mulheres mais conhecidas de Portugal.', 'Esta é uma viagem pelos bastidores de uma profissão que apaixona Judite Sousa há quase quarenta anos.
E é também uma viagem pela sua vida para lá do jornalismo.', 11, 5, 1, 0);

INSERT INTO products VALUES (DEFAULT, 'Microsoft Excel 2007', 20, now(), 22.20, '/images/brands/porto_editora/microsoft_excel_2007.jpeg', 'O Microsoft® Excel® é, sem dúvida, o mais popular programa de folhas de cálculo, com utilização massificada nos meios académicos, profissional e pessoal.

Partindo da nova versão incluída no Microsoft® Office 2007, esta obra destina-se a utilizadores que tendo alguma experiência pretendem expandir os seus conhecimentos para tirarem pleno proveito de todas as funcionalidades disponibilizadas.

Não espere que este seja mais um livro sobre o Excel. Aqui, terá a possibilidade de explorar gradualmente todas as potencialidades desta aplicação, à medida que vai trabalhando para a resolução de problemas concretos.
...
INSERT INTO brandBrandManagers VALUES (37, 1);
INSERT INTO brandBrandManagers VALUES (36, 1);
INSERT INTO brandBrandManagers VALUES (24, 1);
INSERT INTO brandBrandManagers VALUES (11, 1);
INSERT INTO brandBrandManagers VALUES (35, 1);
INSERT INTO brandBrandManagers VALUES (38, 1);
